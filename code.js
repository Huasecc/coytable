  ...
  for (let r = 0; r < rows; r++) {
    ...
    for (let c = 0; c < cols; c++) {
      ...
      if (isH) {
        ...
        try { t.characters = hdrVal; } catch(e) {}
        try { t.fontName = { family: 'Inter', style: headerBold ? 'Semi Bold' : 'Regular' }; } catch(e) {}
        try { t.fontSize = styles.fontSize || 12; } catch(e) {}
        try { t.fills = [fill(tc)]; } catch(e) {}
        try { t.textAlignHorizontal = textHAlign; } catch(e) {}
        if (wrap) { try { t.textAutoResize = 'HEIGHT'; t.resize(w - pl - pr, 0); } catch(e) {} }
        else {
          try { t.textAutoResize = 'NONE'; t.resize(w - pl - pr, Math.round((styles.fontSize||12)*1.35)); t.textTruncation = 'ENDING'; } catch(e) {}
        }
        cell.appendChild(t);
      } else {
        switch (ct) {
          ...
          case 'checkbox': {
            ...
            if (String(val) === '1') {
              ...
              try { chk.characters = '✓'; } catch(e) {}
              try { chk.fontSize = 10; } catch(e) {}
              try { chk.fills = [{ type: 'SOLID', color: hexToRgb('#FFFFFF') }]; } catch(e) {}
               try { chk.textAlignHorizontal = textHAlign; } catch(e) {}
          ...
          case 'index': {
            const t = figma.createText();
            try { t.characters = String(r + 1 - (hasHeader ? 1 : 0)); } catch(e) {}
            try { t.fontSize = styles.fontSize || 12; } catch(e) {}
             try { t.fills = [{ type: 'SOLID', color: hexToRgb('#A1A1AA') }]; } catch(e) {}
             try { t.textAlignHorizontal = textHAlign; } catch(e) {}
             cell.appendChild(t);
            break;
          }
          ...
          case 'progress': {
            ...
            // Track frame clips the fill inside
            ...
            try { lb.characters = pct + '%'; } catch(e) {}
            try { lb.fontSize = 10; } catch(e) {}
            try { lb.fills = [{ type: 'SOLID', color: hexToRgb('#A1A1AA') }]; } catch(e) {}
            try { lb.textAlignHorizontal = textHAlign; } catch(e) {}
            // Auto layout sub-frame
          ...
          case 'tag': {
            ...
            try { txt.fontSize = 11; } catch(e) {}
            try { txt.fontName = { family: 'Inter', style: 'Medium' }; } catch(e) {}
             try { txt.fills = [fill(filled ? '#FFFFFF' : tagColor)]; } catch(e) {}
             try { txt.textAlignHorizontal = textHAlign; } catch(e) {}
          ...
          case 'action': {
            ...
            for (let i = 0; i < n; i++) {
              ...
              const txt = figma.createText();
              try { txt.characters = lb; } catch(e) {}
              try { txt.fontSize = 11; } catch(e) {}
              try { txt.fontName = { family: 'Inter', style: 'Medium' }; } catch(e) {}
              try { txt.fills = [{ type: 'SOLID', color: hexToRgb('#A1A1AA') }]; } catch(e) {}
              try { txt.textAlignHorizontal = textHAlign; } catch(e) {}
          ...
          default: {
             const t = figma.createText();
             try { t.characters = String(val || ''); } catch(e) {}
  ...
  switch (msg.type) {
    ...
    case 'generate-table': {
      try {
        ...
        try { await figma.loadFontAsync(fontRegular); } catch(e) { /* fallback to system font */ }
        try { await figma.loadFontAsync(fontSemiBold); } catch(e) { /* fallback to system font */ }
    ...
    case 'apply-style': {
      ...
      try {
        const fontRegular = { family: 'Inter', style: 'Regular' };
        try { await figma.loadFontAsync(fontRegular); } catch(e) {}
      } catch(e) {}
